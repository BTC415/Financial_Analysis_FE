...
const Navbar = () => {
  return (
    <div className="flex justify-between items-center w-full h-18 bg-white">
      <div className=" p-2">
        <svg width={24} height={24}><use href="#svg-three-bar" /></svg>
      </div>
      <div className='flex flex-row gap-5 justify-between items-center'>
        <div className='bg-[#F3F3F5] flex flex-row items-center gap-3 rounded-md my-2 px-2'>
          <svg width={24} height={24}><use href="#svg-wallet" /></svg>
          <div>
          ...
          <div className='flex items-center justify-between p-2 bg-[#3A5998] rounded-lg'>
            <svg width={20} height={20}><use href='#svg-plus' /></svg>
            <p className='text-white font-lg pl-3'>
              Depositar
            </p>
          </div>
        </div>
        <div>
          <svg width={2} height={40}><use href='#svg-vertical-bar' /></svg>
        </div>
